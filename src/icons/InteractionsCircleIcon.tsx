...
export const InteractionsCircleIcon = React.forwardRef<
  HTMLDivElement,
  BaseIconProps
>(({size = 16, ...props}, ref) => {
  return (
    <BaseIcon {...props} size={size} ref={ref}>
      <svg
        data-wf-icon="InteractionsCircleIcon"
        width="16"
        height="16"
        viewBox="0 0 16 16"
        fill="none"
      ...
      >
        <path
          d="M8.5 6.5V3L5.48901 7.73156C5.27718 8.06442 5.51629 8.5 5.91084 8.5H8.5V12L11.511 7.26844C11.7228 6.93558 11.4837 6.5 11.0892 6.5H8.5Z"
          fill="currentColor"
        />
        <path
          opacity="0.4"
