...
export const AlignContentStretchRowIcon = React.forwardRef<
  HTMLDivElement,
  BaseIconProps
>(({size = 16, ...props}, ref) => {
  return (
...
AlignContentStretchRowIcon.category = 'Layout';


AlignContentStretchRowIcon.displayName = 'AlignContentStretchRowIcon';
