...
export const NineBoxAlignItemsSpaceAroundStretchIcon = React.forwardRef<
  HTMLDivElement,
  BaseIconProps
>((props, ref) => {
  return (
    <BaseIcon {...props} ref={ref}>
      <svg
        data-wf-icon="NineBoxAlignItemsSpaceAroundStretchIcon"
        width="60"
        height="60"
        viewBox="0 0 60 60"
        fill="none"
...
NineBoxAlignItemsSpaceAroundStretchIcon.category = 'Layout';


NineBoxAlignItemsSpaceAroundStretchIcon.displayName = 'NineBoxAlignItemsSpaceAroundStretchIcon';
