...
export const ElementVideoBackgroundIcon = React.forwardRef<
  HTMLDivElement,
  BaseIconProps
>(({size = 16, ...props}, ref) => {
  return (
    <BaseIcon {...props} size={size} ref={ref}>
      <svg
        data-wf-icon="ElementVideoBackgroundIcon"
        width="16"
        height="16"
        viewBox="0 0 16 16"
        fill="none"
      ...
      >
        <path d="M6 5.16406V11L11 8L6 5.16406Z" fill="currentColor" />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
...
ElementVideoBackgroundIcon.tags = [
  'video',
  'videos',
  'background',
  'background video',
