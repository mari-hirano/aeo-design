...
export const FieldOptionIcon = React.forwardRef<HTMLDivElement, BaseIconProps>(
  ({size = 16, ...props}, ref) => {
    return (
      <BaseIcon {...props} size={size} ref={ref}>
        <svg
          data-wf-icon="FieldOptionIcon"
          width="16"
          height="16"
          viewBox="0 0 16 16"
          fill="none"
        ...
        >
          <path
            d="M10.1464 6.14645L8 8.29289L5.85355 6.14645L5.14645 6.85355L8 9.70711L10.8536 6.85355L10.1464 6.14645Z"
            fill="currentColor"
          />
          <path
            fillRule="evenodd"
