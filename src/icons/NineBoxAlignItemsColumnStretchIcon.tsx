...
export const NineBoxAlignItemsColumnStretchIcon = React.forwardRef<
  HTMLDivElement,
  BaseIconProps
>((props, ref) => {
  return (
    <BaseIcon {...props} ref={ref}>
      <svg
        data-wf-icon="NineBoxAlignItemsColumnStretchIcon"
        width="20"
        height="60"
        viewBox="0 0 20 60"
        fill="none"
...
NineBoxAlignItemsColumnStretchIcon.category = 'Layout';


NineBoxAlignItemsColumnStretchIcon.displayName = 'NineBoxAlignItemsColumnStretchIcon';
