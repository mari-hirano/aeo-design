...
export const AddPanelSection64Icon = React.forwardRef<
  HTMLDivElement,
  BaseIconProps
>(({size = 64, ...props}, ref) => {
  return (
    <BaseIcon {...props} size={size} ref={ref}>
      <svg
        data-wf-icon="AddPanelSection64Icon"
        width="64"
        height="64"
        viewBox="0 0 64 64"
        fill="none"
...
AddPanelSection64Icon.category = '64x64 (Add panel)';


AddPanelSection64Icon.displayName = 'AddPanelSection64Icon';
