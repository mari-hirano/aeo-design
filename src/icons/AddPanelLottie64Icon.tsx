...
export const AddPanelLottie64Icon = React.forwardRef<
  HTMLDivElement,
  BaseIconProps
>(({size = 64, ...props}, ref) => {
  return (
    <BaseIcon {...props} size={size} ref={ref}>
      <svg
        data-wf-icon="AddPanelLottie64Icon"
        width="64"
        height="64"
        viewBox="0 0 64 64"
        fill="none"
      ...
      >
        <path
          d="M49 35C49 37.2091 47.2091 39 45 39C42.7909 39 41 37.2091 41 35C41 32.7909 42.7909 31 45 31C47.2091 31 49 32.7909 49 35Z"
          fill="currentColor"
          fillOpacity="0.1"
        />
        <path
