...
export const BoxAddIcon = React.forwardRef<HTMLDivElement, BaseIconProps>(
  ({size = 16, ...props}, ref) => {
    return (
      <BaseIcon {...props} size={size} ref={ref}>
        <svg
          data-wf-icon="BoxAddIcon"
          width="16"
          height="16"
          viewBox="0 0 16 16"
          fill="none"
        ...
        >
          <path
            d="M7.5 8.5V11.5H8.5V8.5H11.5V7.5H8.5V4.5H7.5V7.5H4.5V8.5H7.5Z"
            fill="currentColor"
          />
          <path
            opacity="0.4"
