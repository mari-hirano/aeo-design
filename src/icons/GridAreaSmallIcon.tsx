...
export const GridAreaSmallIcon = React.forwardRef<
  HTMLDivElement,
  BaseIconProps
>(({size = 16, ...props}, ref) => {
  return (
    <BaseIcon {...props} size={size} ref={ref}>
      <svg
        data-wf-icon="GridAreaSmallIcon"
        width="16"
        height="16"
        viewBox="0 0 16 16"
        fill="none"
      ...
      >
        ...
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M5 6C5 5.44772 5.44772 5 6 5H10C10.5523 5 11 5.44772 11 6V10C11 10.5523 10.5523 11 10 11H6C5.44772 11 5 10.5523 5 10V6ZM6 6H10V10H6V6Z"
          fill="currentColor"
        />
      </svg>
    </BaseIcon>
