...
export const UpgradeIcon = React.forwardRef<HTMLDivElement, BaseIconProps>(
  ({size = 16, ...props}, ref) => {
    return (
      <BaseIcon {...props} size={size} ref={ref}>
        <svg
          data-wf-icon="UpgradeIcon"
          width="16"
          height="16"
          viewBox="0 0 16 16"
          fill="none"
        ...
        >
          ...
          />
          <path
            d="M7 6.70711L5.35355 8.35355L4.64645 7.64645L7.5 4.79289L10.3536 7.64645L9.64645 8.35355L8 6.70711V12H7V6.70711Z"
            fill="currentColor"
          />
        </svg>
      </BaseIcon>
