...
export const AlignContentStartRowIcon = React.forwardRef<
  HTMLDivElement,
  BaseIconProps
>(({size = 16, ...props}, ref) => {
  return (
...
AlignContentStartRowIcon.category = 'Layout';


AlignContentStartRowIcon.displayName = 'AlignContentStartRowIcon';
