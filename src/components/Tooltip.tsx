    ...
    <div className="group relative flex">
      ...
      <div className="absolute left-[35px] top-1/2 transform -translate-y-1/2 hidden group-hover:block z-50">
        <div className="flex items-center">
          <div className="w-0 h-0 border-t-[6px] border-t-transparent border-r-[6px] border-r-[#525252] border-b-[6px] border-b-transparent"></div>
          <div className="bg-[#525252] text-secondary text-xs p-2 rounded whitespace-nowrap"
               style={{
